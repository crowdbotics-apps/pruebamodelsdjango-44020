...
## Project Structure
    ...
    ├── pruebamodelsdjango_44020  # Django project configurations
...
1. Clone this repo and `cd pruebamodelsdjango_44020`
...
2. Clone this repo and `cd pruebamodelsdjango_44020`
